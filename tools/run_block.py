...
"""
run_block: Convert an encoded FullBlock from the One blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../one/types/full_block.py) in json format
...
$ca_root is the directory containing your current One config files
$hash is the header_hash of the [BlockRecord](../one/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../one/types/condition_opcodes.py)
...
from one.types.condition_with_args import ConditionWithArgs
...
from one.wallet.cat_wallet.cat_utils import match_cat_puzzle
from one.wallet.puzzles.load_clvm import load_serialized_clvm_maybe_recompile
from one.wallet.uncurried_puzzle import uncurry_puzzle

DESERIALIZE_MOD = load_serialized_clvm_maybe_recompile(
    "chialisp_deserialisation.clvm", package_or_requirement="one.wallet.puzzles"
)
