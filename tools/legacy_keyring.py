"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of one-blockchain. To use this
...
from one.util.errors import KeychainUserNotFound
from one.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
...
DEFAULT_USER = f"user-one-{CURRENT_KEY_VERSION}"  # e.g. user-one-1.8
DEFAULT_SERVICE = f"one-{DEFAULT_USER}"  # e.g. one-user-one-1.8
MAX_KEYS = 100
