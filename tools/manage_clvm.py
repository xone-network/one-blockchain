...
root = here.parent
cache_path = root.joinpath(".one_cache", "manage_clvm.json")
...
from one.types.blockchain_format.program import SerializedProgram  # noqa: E402
...
sys.exit(main(auto_envvar_prefix="ONE_MANAGE_CLVM"))
