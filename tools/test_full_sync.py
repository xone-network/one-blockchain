...
class FakeServer:
    ...
    def get_full_node_outgoing_connections(self) -> List[ws.WSOneConnection]:
        return []
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        one_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            ...
            peer: ws.WSOneConnection = FakePeer()  # type: ignore[assignment]
...
async def run_sync_checkpoint(
    ...
    one_init(root_path, should_check_keys=False, v1_db=False)
    config = load_config(root_path, "config.yaml")
