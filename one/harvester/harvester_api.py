...
from one.plotting.util import PlotInfo, parse_plot_info
from one.protocols import harvester_protocol
from one.protocols.farmer_protocol import FarmingInfo
from one.protocols.harvester_protocol import Plot, PlotSyncResponse
...
from one.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSOneConnection
    ):
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSOneConnection
    ):
        """
