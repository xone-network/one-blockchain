...
from one.protocols.full_node_protocol import RespondBlock
...
from one.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
from one.simulator.time_out_assert import adjusted_timeout
...
from one.wallet.util.wallet_types import AmountWithPuzzlehash
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def farm_blocks_to_puzzlehash(
        ...
        is to receive XONE at an address.
