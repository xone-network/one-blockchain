...
from one.util.file_keyring import FileKeyring, keyring_path_from_root
...
class TempKeyring:
    ...
    def _patch_and_create_keychain(
        ...
        *,
        ...
        mock_supports_os_passphrase_storage_patch = patch("one.util.keychain.supports_os_passphrase_storage")
