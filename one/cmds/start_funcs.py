...
from one.cmds.keys_funcs import migrate_keys
from one.cmds.passphrase_funcs import get_current_passphrase
from one.daemon.client import DaemonProxy, connect_to_daemon_and_validate
from one.util.errors import KeychainMaxUnlockAttempts
from one.util.keychain import Keychain
from one.util.service_groups import services_for_groups
...
async def async_start(
    ...
    if daemon is None:
        print("Failed to create the one daemon")
        return None
