...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older One versions use "
...
@click.option("--prefix", "-x", help="Address prefix (xone for mainnet, txone for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
