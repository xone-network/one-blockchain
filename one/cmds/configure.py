...
from one.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "11211"
                testnet_introducer = "introducer-testnet10.onechain.vip"
                testnet_dns_introducer = "dns-introducer-testnet10.onechain.vip"
                bootstrap_peers = ["testnet10-node.onechain.vip"]
                testnet = "testnet10"
                ...
                mainnet_port = "11111"
                mainnet_introducer = "introducer.onechain.vip"
                mainnet_dns_introducer = "dns-introducer.onechain.vip"
                bootstrap_peers = ["node.onechain.vip"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running one services for changes to take effect")
