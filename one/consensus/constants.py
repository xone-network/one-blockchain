...
class ConsensusConstants:
    ...
    # Forks of one should change this value to provide replay attack protection
    ...
    GENESIS_PRE_FARM_TIMELORD_PUZZLE_HASH: bytes32  # The block at height must pay out to this timelord puzzle hash
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M one.
    MAX_COIN_AMOUNT: int
