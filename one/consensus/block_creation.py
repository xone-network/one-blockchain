...
from one.types.blockchain_format.reward_chain_block import RewardChainBlock, RewardChainBlockUnfinished
...
from one.util.recursive_replace import recursive_replace
...
def create_unfinished_block(
    ...
    if signage_point.cc_vdf is not None:
        ...
        signage_point = SignagePoint(None, None, None, None, signage_point.timelord_fee_puzzle_hash)
