...
from one.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="one_full_node_weight_proof_handler_executor_shutdown_trigger")
