...
from one.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from one.plot_sync.util import Constants
from one.plotting.manager import PlotManager
from one.plotting.util import PlotInfo
...
from one.server.ws_connection import NodeType, ProtocolMessageTypes, WSOneConnection, make_msg
from one.util.generator_tools import list_to_batches
...
class Sender:
    ...
    _connection: Optional[WSOneConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSOneConnection) -> None:
