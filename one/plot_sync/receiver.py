...
from one.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from one.plot_sync.exceptions import (
...
from one.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
class Receiver:
    ...
    def connection(self) -> WSOneConnection:
