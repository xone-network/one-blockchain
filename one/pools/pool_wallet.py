...
from one.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from one.pools.pool_puzzles import (
    SINGLETON_LAUNCHER,
    create_absorb_spend,
    create_full_puzzle,
...
from one.pools.pool_wallet_info import (
    FARMING_TO_POOL,
    LEAVING_POOL,
    SELF_POOLING,
    PoolSingletonState,
...
from one.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from one.wallet.derive_keys import find_owner_sk
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `one singleton` that is
