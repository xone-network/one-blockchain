...
from one.wallet.db_wallet.db_wallet_puzzles import ACS_MU_PH
...
from one.wallet.trading.offer import OFFER_MOD_OLD_HASH, NotarizedPayment, Offer
from one.wallet.trading.trade_status import TradeStatus
from one.wallet.trading.trade_store import TradeStore
...
class TradeManager:
    ...
    Puzzle Drivers:
      - See one/wallet/outer_puzzles.py for a full description of how to build these
    ...
    async def coins_of_interest_farmed(
        self, coin_state: CoinState, fork_height: Optional[uint32], peer: WSOneConnection
    ) -> None:
        """
    ...
    async def check_offer_validity(self, offer: Offer, peer: WSOneConnection) -> bool:
