...
def make_puzzle(amount: int) -> int:
    ...
    if error:
        ...
        for cvp in result_human:
            ...
            total_one += int_from_bytes(cvp.vars[1])
            print(
...
total_one = 0
print("Pool address: ")
total_one += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_one += make_puzzle(farmer_amounts)

assert total_one == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
