...
recompile_requested = (os.environ.get("ONE_DEV_COMPILE_CLVM_ON_IMPORT", "") != "") or ("pytest" in sys.modules)
        ...
        try:
            if pkg_resources.resource_exists(package_or_requirement, clvm_filename):
                ...
                if include_standard_libraries:
                    ...
                    one_puzzles_path = pathlib.Path(pkg_resources.resource_filename(__name__, "__init__.py")).parent
                    search_paths.append(one_puzzles_path)
