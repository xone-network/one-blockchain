...
from one.protocols.full_node_protocol import RequestPeers, RespondPeers
from one.protocols.introducer_protocol import RequestPeersIntroducer, RespondPeersIntroducer
from one.protocols.protocol_message_types import ProtocolMessageTypes
from one.server.address_manager import AddressManager, ExtendedPeerInfo
from one.server.address_manager_sqlite_store import create_address_manager_from_db
from one.server.address_manager_store import AddressManagerStore
...
from one.types.peer_info import PeerInfo, TimestampedPeerInfo
...
class FullNodeDiscovery:
    ...
    async def update_peer_timestamp_on_message(self, peer: WSOneConnection) -> None:
        if (
            peer.is_outbound
            and peer.peer_server_port is not None
            and peer.connection_type is NodeType.FULL_NODE
    ...
    async def _introducer_client(self) -> None:
        ...
        async def on_connect(peer: WSOneConnection) -> None:
    ...
    async def on_connect_callback(self, peer: WSOneConnection) -> None:
