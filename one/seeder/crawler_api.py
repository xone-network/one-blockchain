...
from one.protocols import full_node_protocol, wallet_protocol
from one.seeder.crawler import Crawler
from one.server.outbound_message import Message
...
class CrawlerAPI:
    ...
    @peer_required
    @api_request
    async def request_peers(self, _request: full_node_protocol.RequestPeers, peer: ws.WSOneConnection):
        pass
    ...
    @peer_required
    @api_request
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: ws.WSOneConnection) -> Optional[Message]:
    ...
    @peer_required
    @api_request
    async def new_compact_vdf(self, request: full_node_protocol.NewCompactVDF, peer: ws.WSOneConnection):
        pass
