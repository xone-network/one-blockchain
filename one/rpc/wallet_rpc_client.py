...
from one.data_layer.data_layer_wallet import Mirror, SingletonRecord
from one.pools.pool_wallet_info import PoolWalletInfo
...
class WalletRpcClient(RpcClient):
    """
    Client to One RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    ...
    async def nft_mint_bulk(
        ...
        xone_coins: Optional[List[Dict]] = None,
        xone_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xone_change_target": xone_change_target,
