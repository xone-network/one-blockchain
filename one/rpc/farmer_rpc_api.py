...
from one.protocols.harvester_protocol import Plot
...
from one.util.paginator import Paginator
                ...
                if sp.challenge_chain_sp == sp_hash:
                    ...
                    return {
                        "signage_point": {
                            ...
                            "timelord_fee_puzzle_hash": sp.timelord_fee_puzzle_hash,
                        },
                        "proofs": pospaces,
                    }
