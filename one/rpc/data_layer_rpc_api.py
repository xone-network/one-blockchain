...
from one.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from one.rpc.data_layer_rpc_util import marshal
...
from one.util.streamable import recurse_jsonify
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "one_data_layer"
