...
git submodule update --init one-blockchain-gui

Set-Location -Path ".\one-blockchain-gui" -PassThru
...
Write-Output "Remove unused @xone-network packages to make cache slim"
...
Remove-Item "@xone-network" -Recurse -Force
